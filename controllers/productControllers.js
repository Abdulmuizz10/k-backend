...
//     // Split the query into individual words and create regex patterns for each word
//     const words = query.split(/\s+/).filter(Boolean);
//     const regexConditions = words.map((word) => ({
//       name: { $regex: new RegExp(word, "i") },
//     }));

//     // Perform the search with multiple word matches
//     const products = await ProductModel.aggregate([
//       {
//         $match: {
//           $or: regexConditions, // Match any product that contains at least one of the words
//         },
//       },
//       {
//         $addFields: {
...
//         },
//       },
//       { $sort: { relevance: -1, name: 1 } }, // Sort by relevance first, then alphabetically
//     ]);
